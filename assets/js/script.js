...
function answerIsWrong() {
    ...
    timeLeft -=10;
    alert('Incorrect! 10 seconds lost!');
};
...
function enterScore() {
    ...
    document.getElementById("finalScore").innerHTML = "Score is " + score + " points out of 5";
};

// reaction based upon answer
